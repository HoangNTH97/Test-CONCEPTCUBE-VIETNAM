    ...
    return (
        <header className={cx('header')}>
            ...
            <div className={cx('header-responsive')}>
                <div onClick={() => setModalSearch(false)} className={cx('search-responsive')}>
            ...
            <div className={cx('wrapper', !modalSearch ? 'active' : '')}>
                <div onClick={() => setModalSearch(true)} className={cx('close-header')}>
                    <CloseIcon />
                </div>
