...
export const AddIcon2 = () => (
    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill="#070707" fillOpacity="1" fillRule="evenodd" d="M.875 0h14v14h-14V0z" />
        <path
            fill="#FFF"
            fillRule="evenodd"
            d="M1 14V8h14v6H1zm.999-9H14v2H1.999V5zm2-3h8.002v2H3.999V2z"
...
export const ArrowDownIcon = () => (
    <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill="#333" fillOpacity="0" fillRule="evenodd" d="M.001 0h10v10h-10V0z" />
        <path
            fill="#8F8F8F"
            fillRule="evenodd"
...
export const DeleteIcon = () => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fillOpacity="0" fillRule="evenodd" d="M-.001 0h20v20h-20V0z" />
        <path
            fill="#777"
            fillRule="evenodd"
            d="M18.997 17.551l-1.445 1.445-7.567-7.566-7.349 7.348-1.413-1.414 7.347-7.348-7.568-7.567L2.45 1.003l7.566 7.567 7.349-7.348 1.415 1.414-7.349 7.348 7.566 7.567z"
        />
    </svg>
);
export const ReportIcon1 = () => (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fillOpacity="0" fillRule="evenodd" d="M-.001 0h20v20h-20V0z" />
        <path
            fill="#777"
            fillRule="evenodd"
            d="M10 0C4.478 0-.001 4.477-.001 10S4.478 20 10 20c5.523 0 9.999-4.477 9.999-10S15.523 0 10 0zm7.604 10c0 1.646-.531 3.167-1.423 4.413L5.588 3.819C6.835 2.927 8.354 2.396 10 2.396c4.193 0 7.604 3.411 7.604 7.604zm-15.21 0c0-1.646.533-3.168 1.425-4.413l10.593 10.594c-1.245.891-2.765 1.423-4.412 1.423-4.191 0-7.606-3.411-7.606-7.604z"
        />
    </svg>
);
...
export const IllustratorIcon = () => (
    <svg width="89" height="30" viewBox="0 0 89 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill="#300" fillRule="evenodd" d="M-.001 0H89v30H-.001V0z" />
        <text
            fill="#FF9A00"
            fontFamily="Montserrat"
            fontSize="22.254"
            transform="matrix(.62909 0 0 .62909 11.485 19.847)"
        >
            Illustrator
        </text>
    </svg>
...
export const PhotoshopIcon = () => (
    <svg width="97" height="30" viewBox="0 0 97 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill="#001E36" fillRule="evenodd" d="M0 0h97v30H0V0z" />
        <text
            fill="#31A8FF"
            fontFamily="Montserrat"
            fontSize="22.254"
            transform="matrix(.62909 0 0 .62909 11.427 20.09)"
        >
            Photoshop
        </text>
    </svg>
...
export const PremiereIcon = () => (
    <svg width="85" height="30" viewBox="0 0 85 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill="#00005B" fillRule="evenodd" d="M.002 0h84.999v30H.002V0z" />
        <text
            fill="#B5B5FF"
            fontFamily="Montserrat"
            fontSize="22.254"
            transform="matrix(.62909 0 0 .62909 11.533 19.347)"
        >
            Premiere
        </text>
    </svg>
...
export const ShareIcon = () => {
    <svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill="#070707" fillOpacity="1" fillRule="evenodd" d="M0 0h16v16H0V0z" />
        <path
            fill="#070707"
            fillRule="evenodd"
