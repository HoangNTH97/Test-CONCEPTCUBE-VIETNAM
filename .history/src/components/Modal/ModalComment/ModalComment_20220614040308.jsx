                    ...
                    {commentList.map((item, index) => (
                        <div className={cx('comment-item')}>
                            ...
                            <div className={cx('comment-content')}>
                                <p>
                                    Amazing work you have here. feels like an alternative reality
                                    with that much saturation.. love it! Amazing work you have here
                                    feels like an alternative reality with that much saturation..
                                    love it!
                                </p>
                            </div>
                        </div>
